...
function setQuestion(answer,gamerNumber) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (gamerNumber == "1") {
                ...
                if (result.gamer1Finish == true) {
                    window.location.href = "/Home/Index?winnerOrLoser=winner";
                }
            }
            if (gamerNumber == "2") {
                document.getElementById('Gamer1Question').value = result.gamer2Question;
                if (result.gamer2Finish == true) {
                    window.location.href = "/Home/Index?winnerOrLoser=winner";
                }
            }
